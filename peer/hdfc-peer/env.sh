...
export CORE_PEER_FILESYSTEMPATH=$HOME/ledgers/peer/hdfc/ledger

# Identity set to Admin
export CORE_PEER_MSPCONFIGPATH=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/hdfc.com/users/Admin@rbi.com/msp
