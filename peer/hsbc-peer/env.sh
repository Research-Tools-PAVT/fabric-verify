...
export CORE_PEER_FILESYSTEMPATH=$HOME/ledgers/peer/hsbc/ledger

# Identity set to Admin
export CORE_PEER_MSPCONFIGPATH=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/hsbc.com/users/Admin@hsbc.com/msp
