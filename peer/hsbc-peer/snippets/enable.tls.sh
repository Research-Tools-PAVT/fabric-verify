...
export  CORE_PEER_TLS_CERT_FILE=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/icici.com/peers/icici-main-peer/tls/server.crt
export  CORE_PEER_TLS_ROOTCERT_FILE=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/icici.com/peers/icici-main-peer/tls/ca.crt