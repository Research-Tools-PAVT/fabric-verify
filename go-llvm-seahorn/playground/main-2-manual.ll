...
entry:
  ...
  %b.ld.0 = load i32, i32* %b.0, align 4
  %icmp.1 = icmp sgt i32 %b.ld.0, 0
  %zext.1 = zext i1 %icmp.1 to i32
  call void @__VERIFIER_assume(i32 %zext.1)
  
  %a.ld.1 = load i32, i32* %a.0, align 4
  %add.0 = add i32 %a.ld.1, 50
  
  %a.ld.2 = load i32, i32* %a.0, align 4
  %b.ld.1 = load i32, i32* %b.0, align 4
  %add.1 = add i32 %a.ld.2, %b.ld.1
  %icmp.2 = icmp sgt i32 %add.0, %add.1
  
  br i1 %icmp.2, label %block_true, label %block_false
